...
glm::vec3 RigidBody::forward() const {
    return vectorToWorldSpace(glm::vec3{0.0f, 0.0f, -1.0f});
}

glm::vec3 RigidBody::right() const {
    return vectorToWorldSpace(glm::vec3{1.0f, 0.0f, 0.0f});
}

glm::vec3 RigidBody::up() const {
    return vectorToWorldSpace(glm::vec3{0.0f, 1.0f, 0.0f});
